...
{
    const string privateCode = "-w1Lu9vWP0aojbRGkGF1mwfIYb57L3uEemQHrSWmxiVw";  //Key to Upload New Info
    const string publicCode = "62c495508f40bbc4cc19311d";   //Key to download
    const string webURL = "http://dreamlo.com/lb/"; //  Website the keys are for

    public SubmitName nameScript;
